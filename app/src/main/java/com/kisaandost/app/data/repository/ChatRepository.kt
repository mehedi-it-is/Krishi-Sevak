package com.kisaandost.app.data.repository

import com.kisaandost.app.data.local.db.ChatDao
import com.kisaandost.app.data.local.db.ChatEntity
import com.kisaandost.app.data.local.db.MessageEntity
...
import com.kisaandost.app.data.remote.mandi.MandiMockProvider
import com.kisaandost.app.data.remote.sarvam.SarvamApi
import com.kisaandost.app.data.remote.sarvam.SarvamChatMessage
import com.kisaandost.app.data.remote.sarvam.SarvamChatRequest
import com.kisaandost.app.utils.LocalSmartAiEngine
...
class ChatRepository(
    ...
    suspend fun analyzeCropAndGetAdvisory(
        ...
        val hiddenSystemPrompt = """
            You are Kisaan Dost, an empathetic & expert AI agricultural assistant for Indian farmers.
    ...
    suspend fun sendTextMessage(
        ...
        val systemPrompt = """
            You are Kisaan Dost, a knowledgeable and practical AI farming companion for Indian farmers.
