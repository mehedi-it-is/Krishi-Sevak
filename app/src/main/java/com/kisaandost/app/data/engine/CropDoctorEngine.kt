    ...
    fun evaluate(input: CropDoctorInput, langCode: String = "en"): CropDoctorResult {
        ...
        when (code) {
            "hi" -> {
                ...
                plan7Day.add("दिन 7: फसल की वृद्धि परखें; किसी भी पीले पत्ते को किसान दोस्त AI से स्कैन करें।")
            }
            "mr" -> {
                ...
                plan7Day.add("दिवस ७: पिकाची पाहणी करा; संशयित पानाचा किसान दोस्त AI द्वारे फोटो काढून निदान करा.")
            }
            "bn" -> {
                ...
                plan7Day.add("দিন ৭: ফসলের স্বাস্থ্য পরীক্ষা করে কিষাণ দোস্ত AI তে স্ক্যান করুন।")
            }
            "te" -> {
                ...
                plan7Day.add("రోజు 7: కిసాన్ దోస్త్ AI ద్వారా అనుమానాస్పద ఆకులను స్కాన్ చేయండి.")
            }
            "ta" -> {
                ...
                plan7Day.add("நாள் 7: கிசான் தோஸ்த் AI மூலம் இலைகளை ஸ்கேன் செய்து கண்காணிக்கவும்.")
            }
            else -> {
                ...
                plan7Day.add("Day 7: Re-evaluate crop vigour; click and scan any suspicious leaf with Kisaan Dost AI.")
            }
        }
