        ...
        return when (langCode.lowercase()) {
            "hi" -> when {
                ...
                lower.contains("मंडी") || lower.contains("भाव") || lower.contains("दाम") || lower.contains("price") ->
                    ...
                    "किसान दोस्त सलाह: आपकी फसल की अच्छी पैदावार के लिए नियमित जल प्रबंधन रखें, खरपतवार निकालें और मौसम का पूर्वानुमान देखकर ही कृषि कार्य करें।"
            }
            "mr" -> when {
                ...
                lower.contains("भाव") || lower.contains("बाजार") || lower.contains("मंडी") ->
                    ...
                    "किसान दोस्त सल्ला: पिकांच्या जोमदार वाढीसाठी ठिबक सिंचनाचा वापर करा, तण नियंत्रण ठेवा आणि हवामान अंदाज पाहून फवारणीचे नियोजन करा."
            }
            "bn" -> when {
                ...
                lower.contains("সার") || lower.contains("ইউরিয়া") ->
                    ...
                    "কৃষক বন্ধু পরামর্শ: ফসলের ভালো ফলনের জন্য সঠিক সেচ দিন, আগাছা মুক্ত রাখুন এবং আবহাওয়ার পূর্বাভাস দেখে ওষুধ স্প্রে করুন।"
            }
            "te" -> when {
                ...
                lower.contains("ఎరువు") || lower.contains("యూరియా") ->
                    ...
                    "రైతు నేస్తం సలహా: అధిక దిగుబడి కోసం సరైన నీటి యాజమాన్యం పాటించండి మరియు వాతావరణ సమాచారం ఆధారంగా వ్యవసాయ పనులు చేపట్టండి."
            }
            "ta" -> when {
                ...
                lower.contains("உரம்") || lower.contains("யூரியா") ->
                    ...
                    "விவசாயி தோழன்: அதிக மகசூலுக்கு சொட்டுநீர் பாசனம் அமைக்கவும் மற்றும் வானிலை முன்னறிவிப்பு பார்த்து பூச்சிக்கொல்லி தெளிக்கவும்."
            }
            "kn" ->
                "ಕೃಷಿ ತಜ್ಞರ ಸಲಹೆ: ಬೆಳೆ ಸಂರಕ್ಷಣೆಗಾಗಿ ಬೇವಿನ ಎಣ್ಣೆ (3 ಮಿಲಿ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ. ಮಣ್ಣು ಪರೀಕ್ಷೆ ಆಧಾರದ ಮೇಲೆ ಸಮತೋಲಿತ ರಸಗೊಬ್ಬರ ಮತ್ತು ಹನಿ ನೀರಾವರಿ ಬಳಸಿ."
            "ml" ->
                "കാർഷിക വിദഗ്ദ്ധോപദേശം: കീടങ്ങളെ നിയന്ത്രിക്കാൻ വേപ്പെണ്ണ മിശ്രിതം തളിക്കുക. മണ്ണുപരിശോധന അടിസ്ഥാനമാക്കി വളപ്രയോഗം നടത്തുക."
            "gu" ->
                "કૃષિ સલાહ: પાકમાં જીવાત નિયંત્રણ માટે લીમડાનું તેલ (@ ૩ મિલી/લિટર) છાંટો. જમીન ચકાસણી મુજબ સંતુલિત ખાતર આપો."
            "pa" ->
                "ਖੇਤੀ ਮਾਹਿਰਾਂ ਦੀ ਸਲਾਹ: ਕੀੜਿਆਂ ਦੀ ਰੋਕਥਾਮ ਲਈ ਨਿੰਮ ਦੇ ਤੇਲ ਦਾ ਛਿੜਕਾਅ ਕਰੋ। ਮਿੱਟੀ ਦੀ ਪਰਖ ਅਨੁਸਾਰ ਸੰਤੁਲਿਤ ਖਾਦਾਂ ਦੀ ਵਰਤੋਂ ਕਰੋ।"
            "or" ->
                "କୃଷି ପରାମର୍ଶ: ଫସଲରେ ପୋକ ନିୟନ୍ତ୍ରଣ ପାଇଁ ନିମ୍ବ ତେଲ (3 ମି.ଲି./ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ। ମାଟି ପରୀକ୍ଷା ଅନୁଯାୟୀ ସନ୍ତୁଳିତ ସାର ପ୍ରୟୋଗ କରନ୍ତୁ।"
            else ->
