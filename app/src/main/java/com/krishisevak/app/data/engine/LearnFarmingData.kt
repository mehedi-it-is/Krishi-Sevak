...
object LearnFarmingData {
    ...
    private val bengaliTips = listOf(
        ...
        FarmingGuideTip(
            id = 3,
            iconEmoji = "💧",
            title = "ড্রিপ সেচ ও জল ব্যবস্থাপনা",
            summary = "ড্রিপ সেচ সরাসরি শিকড়ে জল পৌঁছে দেয় এবং ৫০% জল সাশ্রয় করে।",
            detailedContent = "ড্রিপ সেচে জল ও দ্রবণীয় সার সরাসরি শিকড়ে যায়, ফলে আগাছা কম হয়।",
            practicalSteps = listOf(
                "ফসলের সারি অনুযায়ী ড্রিপ পাইপ স্থাপন করুন।",
                "ড্রিপের মাধ্যমে ফার্টিগেশন (জলে দ্রবণীয় সার) দিন।",
        ...
        FarmingGuideTip(
            ...
            practicalSteps = listOf(
                ...
                "লবণ জলের দ্রবণ দিয়ে হালকা ও অপুষ্ট বীজ আলাদা করুন।",
